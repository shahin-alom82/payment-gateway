            ...
            <div className="lg:mt-16">
                  <Container className="text-lightText flex flex-col lg:flex-row justify-between gap-10">
                        ...
                        <div className="lg:mt-14 mt-10 flex-1">
                              <h1 className="flex items-center gap-2 lg:text-[16px] text-xs rounded-md bg-gray-900/50 py-1.5 px-3 tracking-wide  lg:w-[310px] w-[240px]">
                                    ...
                                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center">
                                          ...
                                          <div className="lg:w-36 w-24 lg:h-36 h-24 mt-6 lg:mt-0 flex items-center justify-center rounded-full border-2 border-textColor">
                                                <div className="flex flex-col items-center">
                                                      ...
                                                      <span className="text-sm lg:text-lg">Started</span>
                                                </div>
                                          </div>
                                    </div>
                        ...
                        <div className="flex-1 flex justify-center items-center">
                              <img src={robot} alt="robotImage" className="lg:h-[580px] h-[300px]" />
                        </div>
                  </Container>
                  {/* Count Section */}
                  <div className="max-w-screen-xl mx-auto lg:px-0 px-4 flex lg:gap-0 gap-10 flex-col lg:flex-row justify-between lg:items-center lg:mt-10 mt-4 text-lightText">
                        <div>
                              <h1 className="text-2xl flex items-center gap-4"><span className="lg:text-5xl font-semibold">3800+</span> User Active</h1>
                        </div>
                        <div>
                              <h1 className="text-2xl flex items-center gap-4"><span className="lg:text-5xl font-semibold">230+</span> Trusted by Company</h1>
                        </div>
                        <div>
                              <h1 className="text-2xl flex items-center gap-4"><span className="lg:text-5xl font-semibold">230M+</span> Transaction</h1>
                        </div>
                  </div>
            </div>
      );
